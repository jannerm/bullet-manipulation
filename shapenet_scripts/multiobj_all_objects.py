...
for obj in range(32):
    data_save_path = "/home/ashvin/data/s3doodad/sasha/demos/%s/%s.pkl" % (args.name, str(obj))
    video_save_path = "/home/ashvin/data/s3doodad/sasha/demos/%s/videos/%s" % (args.name, str(obj))
    ...
    for i in tqdm(range(args.num_trajectories)):
        ...
        for j in range(args.num_timesteps):
            ...
            # print(env.get_object_midpoint(object_name))
