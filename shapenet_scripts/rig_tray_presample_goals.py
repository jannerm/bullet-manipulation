...
for obj in ['mug', 'long_sofa', 'camera', 'grill_trash_can', 'beer_bottle']:
    ...
    data_save_path = "/home/ashvin/data/rail-khazatsky/sasha/presampled_goals/affordances/combined/tray_{0}_goals.pkl".format(obj)
    env = roboverse.make('SawyerRigMultiobjTray-v0', test_env=True, object_subset=[obj])
