...
for j in tqdm(range(args.num_trajectories)):
    ...
    for i in range(args.num_timesteps):
        ...
        action = env.get_demo_action(first_timestep=(
            i == 0), final_timestep=(i == args.num_timesteps-1))
    ...
    if ((j + 1) % 500) == 0:
        curr_name = demo_data_save_path + \
            '_{0}.pkl'.format(num_datasets+args.offset)
