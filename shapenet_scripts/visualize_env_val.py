...
#obs_img_dim=196, 
env = rv.make(
    "SawyerDiverseVAL-v0", #"SawyerDiverseDrawerPnpPush-v0", #"SawyerRigAffordances-v6", #"SawyerResetFreeDrawerPnpPush-v0", 
    gui=False, 
    expl=True, 
    reset_interval=1, #10, 
...
for i in range(num_traj):
    ...
    for t in range(ts):
        ...
        action = env.get_demo_action(first_timestep=(t == 0))
