...
# THINGS TO DEFINE: POS LIM

class FlipPotV0(BridgeKitchenVO):
    ...
    def _load_environment(self):
        ...
        ### WALLS ###
        tile_wall = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/tile_wall/tile_wall.urdf',
            pos=[1.78, -0.3, -0.215],
        ...
        ### MARBLE TABELS ###
        marble_table = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/marble_table/marble_table.urdf',
            pos=[2.2, 0.745, -0.765],
        ...
        ### SINK ###
        stovetop = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/stovetop/stovetop.urdf',
            pos=[2.035, -.15, -0.5514],
            quat=deg_to_quat([90, 0, 90]),
            scale=0.43,
            useFixedBase=True)
        ...
        wood_table = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/wood_table/wood_table.urdf',
            pos=[2.168, -.184, -0.583],
        ...
        stove_base = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/stove_base/stove_base.urdf',
            pos=[2.02, -.184, -0.5829],
            quat=deg_to_quat([90, 0, 270]),
            scale=0.48,
            useFixedBase=True)
        ...
        table = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/table/table.urdf',
            pos=[2.13, 0, -0.9],
            quat=deg_to_quat([90, 0, 270]),
            scale=1.0,
            useFixedBase=True)
        ...
        faucet = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/faucet/faucet.urdf',
        ...
        oven = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/oven/oven.urdf',
            pos=[2.34, -.165, -0.68],
            quat=deg_to_quat([90, 0, 270]),
            scale=0.65,
            useFixedBase=True)
        ...
        sink_drawer = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/sink_drawer/sink_drawer.urdf',
        ...
        ### DISH RACK ###
        dish_rack = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/dish_rack/dish_rack.urdf',
            pos=[2.13, 0.425, -0.61],
            quat=deg_to_quat([90, 0, 270]),
            scale=0.4,
            useFixedBase=True)
        ...
        utensil_holder = load_urdf('/Users/sasha/Desktop/pybullet/ShapeNet/Furniture/utensil_holder/utensil_holder.urdf',
            pos=[2.015, 0.34, -0.53],
            quat=deg_to_quat([90, 0, 90]),
            scale=0.1,
            useFixedBase=True)
